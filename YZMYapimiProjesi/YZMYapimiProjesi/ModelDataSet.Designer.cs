...
namespace YZMYapimiProjesi.ModelDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([Id], [KullaniciAdi], [Sifre], [Adi], [Soyadi], [Email], [TCKimlik], [Tel], [Adres], [KullaniciTipi]) VALUES (@Id, @KullaniciAdi, @Sifre, @Adi, @Soyadi, @Email, @TCKimlik, @Tel, @Adres, @KullaniciTipi);
SELECT Id, KullaniciAdi, Sifre, Adi, Soyadi, Email, TCKimlik, Tel, Adres, KullaniciTipi FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [KullaniciAdi] = @KullaniciAdi, [Sifre] = @Sifre, [Adi] = @Adi, [Soyadi] = @Soyadi, [Email] = @Email, [TCKimlik] = @TCKimlik, [Tel] = @Tel, [Adres] = @Adres, [KullaniciTipi] = @KullaniciTipi WHERE (([Id] = @Original_Id) AND ([KullaniciAdi] = @Original_KullaniciAdi) AND ([Sifre] = @Original_Sifre) AND ([Adi] = @Original_Adi) AND ([Soyadi] = @Original_Soyadi) AND ([Email] = @Original_Email) AND ([TCKimlik] = @Original_TCKimlik) AND ([Tel] = @Original_Tel) AND ([Adres] = @Original_Adres) AND ([KullaniciTipi] = @Original_KullaniciTipi));
SELECT Id, KullaniciAdi, Sifre, Adi, Soyadi, Email, TCKimlik, Tel, Adres, KullaniciTipi FROM [Table] WHERE (Id = @Id)";
        ...
        public virtual int Insert(int Id, string KullaniciAdi, string Sifre, string Adi, string Soyadi, string Email, long TCKimlik, long Tel, string Adres, bool KullaniciTipi) {
            ...
            this.Adapter.InsertCommand.Parameters[9].Value = ((bool)(KullaniciTipi));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((bool)(KullaniciTipi));
            ...
            this.Adapter.UpdateCommand.Parameters[19].Value = ((bool)(Original_KullaniciTipi));
        ...
        public virtual int Update(
                    ...
                    string Original_Adres, 
                    bool Original_KullaniciTipi) {
            return this.Update(Original_Id, KullaniciAdi, Sifre, Adi, Soyadi, Email, TCKimlik, Tel, Adres, KullaniciTipi, Original_Id, Original_KullaniciAdi, Original_Sifre, Original_Adi, Original_Soyadi, Original_Email, Original_TCKimlik, Original_Tel, Original_Adres, Original_KullaniciTipi);
        }
    }
